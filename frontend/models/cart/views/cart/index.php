                    ...
                    <table class="table table-striped">
                        ...
                        if (!empty($sesGoods)) {
                            ...
                            foreach ($sesGoods as $sGoods) {
                                $prise='';
                                if(!isset($sGoods->sizes)||$sGoods->sizes->key_feild=='size1'||$sGoods->sizes->id==7){
                                    $prise= $sGoods->prises->price1;
                                }elseif($sGoods->sizes->key_feild=='size2'){
                                    $prise= $sGoods->prises->price2;
                                }elseif($sGoods->sizes->key_feild=='size3'){
                                    $prise= $sGoods->prises->priceEvro;
                                }elseif($sGoods->sizes->key_feild=='size4'){
                                    $prise= $sGoods->prises->priceSem;
                                }elseif($sGoods->sizes->key_feild=='size5'){
                                    $prise= $sGoods->prises->wholesale;
                                }elseif($sGoods->sizes->key_feild=='size6'){
                                    $prise= $sGoods->prises->addtional;
                                }
                                if($counter==0)
                            ...
                            <tr>
                                <td>
                                    ...
                                    if(isset($img)){
                                        foreach($img as $image){
                                            echo Html::img(Yii::getAlias('@frontendWebroot/image/') . $image->path . 'gods-' . $image->name, ['alt' => $sGoods->gods->title,'width'=>50]);}
                                    }
                                    ?>
                                ...
                                <td><p>
                                        <?php
                                        if(isset($sGoods->sizes->value)||$sGoods->sizes->value!=0)
                                            echo "<span class='fa fa-square' style='color:".$sGoods->sizes->value."'></span>";
                                        else
                                            echo"Цвет не выбран";
                                        ?>
                                    </p></td>
                                <td><p>
                                        <?php
                                        if(isset($sGoods->sizes)||$sGoods->sizes->value!=0){
                        ...
                        if (!empty($userGoods)) {
                            ...
                            foreach ($userGoods as $uGoods) {
                                ...
                                <tr>
                                    ...
                                    <td><p>
                                            <?php
                                                if(isset($uGoods->sizes->value)||$uGoods->sizes->value!=0)
                                                    echo "<span class='fa fa-square' style='color:".$uGoods->sizes->value."'></span>";
                                                else
                                                    echo"Цвет не выбран";
                                            ?>
                                        </p></td>
