...
if(isset($title)){
    ...
    $this->title = 'купить недорого '.$models->title.' в интернет магазине "Милый дом"';
}
...
if(isset($models->quote)){
    ...
    $descriptions = strip_tags($models->discription_gods);
                ...
                <div class="col-md-10 col-lg-10 col-sm-24">
                            ...
                            <p class="col-lg-24 col-md-24 col-sm-24 col-xs-24 color">
                                ...
                                if(isset($colors)){
                                    foreach ($colors as $color) {
                                        ?>
                                        <span class="fa fa-square fa-4x colorinput" style="color:<?= $color->value; ?>" data-color-id="<?= $color->id; ?>" data-color="<?= $color->value; ?>"></span>
                                        <?php
                                    }
                                } ?>
                            </p>
                    ...
                    <div class="col-lg-24 col-md-24 col-sm-24 col-xs-24 description ">
                        ...
                        <div class="col-lg-24 col-md-24 col-sm-24 col-xs-24"><p><strong><?= Yii::t('frontend','SIZES_VIEWS') ?>: </strong>
                         <?php       $sizeViews= array_filter($models->addfeilds, function ($item){
                                    return $item->key_feild=='size1';
                                });
                                foreach ($sizeViews as $addfeild){
                                    echo "$addfeild->value ,";
                                }
                            }
                             ?>
