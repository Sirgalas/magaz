                    ...
                    <div class="col-lg-24 col-md-24 col-sm-24 col-xs-24 comment">
                        <div class="avatar col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <?php if(isset($comment->user->avatar)){ ?>
                                <?= Html::img(Yii::getAlias('@frontendWebroot').'/image/'.$comment->user->avatar,['class'=>'col-lg-24 col-md-24 col-sm-24 col-xs-24','alt'=>Yii::$app->user->username.'-avatar','width'=>'105']); ?>
                            <?php }else{ ?>
