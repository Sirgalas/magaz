...
/**
 * SliderController implements the CRUD actions for FrontendSetup model.
 */
class SliderController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $basePath='frontendImage/slider/'.date('Y').'/'.date('m').'/';
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if(isset($page['key_setup'])){
                $varFr=$model->imageSlider($page['vaelye'],Yii::getAlias('@frontendWebroot/image/').$basePath);
                $model->vaelye=$varFr;
                $model->save();
            }
            return $this->redirect(['index', 'FrontendSetupSearch[description]' => 'slider']);
        } else {
            return $this->render('create', [
                'model' => $model,
            ]);
