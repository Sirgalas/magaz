...
class Catgodpost extends \yii\db\ActiveRecord
{
    ...
    /*public function afterSave($insert, $changedAttributes)
    {
        ...
        if($product){
            ...
            $add['id']=$this->category->id;
            $add['categorySize']=$this->category->size;
            $add['name']=$this->category->name;
            $product->save();
        }
    }
    ...
    private function allCat($id_goods){
        return ArrayHelper::map(Catgodpost::find()->where(['id_gods'=>$id_goods])->with('category')->asArray()->all(),'category.name','id_cat');
    }
}
